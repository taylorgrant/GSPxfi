  ...
  if (any(stringr::str_detect(names(tbl), "facebook"))) {
    ...
    tbl |>
      dplyr::rename(
        ...
        impressions = impressions_sum,
        clicks = clicks_sum,
        likes = tik_tok_paid_likes_sum,
        shares = tik_tok_paid_shares_sum,
        comments = tik_tok_paid_comments_sum,
        follows = tik_tok_paid_follows_sum,
        profile_visits = tik_tok_paid_profile_visits_sum,
        video_views = tik_tok_video_views_sum,
        video_views2 = tik_tok_2_second_video_views_sum,
        video_views6 = tik_tok_6_second_video_views_sum,
        video_views6fv = tik_tok_6_second_focused_views_sum,
        video_views15fv = tik_tok_15_second_focused_views_sum,
